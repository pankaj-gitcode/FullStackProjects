...
export default function Sidebar(){
    return(<>
        {/* ---------------------- SIDEBAR -------------------- */}
        <div className="w-[50vw] lg:w-[18%] h-[min(100vh)] border-[3px] border-gray-300 border-solid border-t-0">

            {/* ---------------------- sidebar-Container: divs --------------------- */}
            <div className="flex flex-col items-end gap-6 pt-12 ">

                    {/* -------------------- sidebar: items ------------------------ */}
                <div className="flex items-center gap-2 border-[3px] border-gray-300 w-[70%] py-2 pl-2 border-r-0 cursor-pointer rounded-l-lg  ">
