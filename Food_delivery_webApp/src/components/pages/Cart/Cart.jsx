                    ...
                    <div className="pt-6">
                    {
                        foodItem.map((elem,index)=>{
                            ...
                            if(countItems[elem._id] > 0){return(
                                <div key={index} className="grid grid-cols-6 items-center justify-between text-sm gap-5 lg:gap-0">
                    ...
                    <div className="grid grid-cols-2 gap-10 mt-10">
                        ...
                        <div>
                            ...
                            <div className="grid grid-cols-2 text-sm w-[50vw]">
                                ...
                                <button className="bg-orange-600 text-[#fff] px-2 py-1 lg:px-4 lg:py-1 rounded-sm text-xs lg:text-sm active:scale-105 mt-2">PROCEED TO CHECKOUT</button>
                        ...
                        <div className="">
                            ...
                            <div>
                                <input type="text" placeholder="Enter Promocode" className="bg-slate-200 text-sm pl-2 pr-20 py-1 rounded-l-sm focus:outline-none"/>
                                <button className="bg-[#000] text-[#fff] text-sm py-1 px-5 rounded-r-sm">Submit</button>
                            </div>
                        </div>
                    </div>
